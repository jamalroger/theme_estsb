...
<?php endif; ?>
	...
	<ol>
		<?php wp_list_comments('type=comment&callback=estsb_comment'); ?>
	</ol>
...
<?php if ( comments_open() ) :
	...
	ob_start();
	comment_form($estsb_comment_args);
	$form_object = ob_get_clean();
	echo estsb_decruft_comment_form($form_object);
